...
class TestDeliveryCost(unittest.TestCase):
    ...
    negative_sample_argument = ['main.py', '-100.50', -2, 'PKG1', -50, -30, 'OFR001', 'PKG2', -75, -125, 'OFR008']
    ...
    def test_input_argument_float_negative(self):
        self.assertEqual(input_argument_float(1, self.negative_sample_argument), None)

    def test_input_argument_int(self):
        self.assertEqual(input_argument_int(2, self.sample_argument), 2)

    def test_input_argument_int_negative(self):
        self.assertEqual(input_argument_int(2, self.negative_sample_argument), None)

    def test_input_package(self):
        result = [('PKG1', 50, 30, 'OFR001'), ('PKG2', 75, 125, 'OFR008')]
        self.assertEqual(input_argument_package(self.sample_argument, 2), result)

    def test_input_package_negative(self):
        self.assertEqual(input_argument_package(self.negative_sample_argument, 2), None)
